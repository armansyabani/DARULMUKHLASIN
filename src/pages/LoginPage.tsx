...
import { Building2, Lock, Mail, Eye, EyeOff, ArrowRight, UserCheck } from 'lucide-react';
      ...
      >
        ...
        <div className="mt-8 pt-6 border-t-4 border-black border-dashed text-center">
          ...
          <button
            ...
            disabled={isSubmitting}
            className="w-full py-3 bg-lime-400 hover:bg-lime-300 active:translate-y-1 active:shadow-[0px_0px_0px_0px_rgba(0,0,0,1)] border-4 border-black text-black font-black text-sm uppercase flex items-center justify-center gap-2.5 transition-all shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] cursor-pointer rounded-xl"
          >
            <img 
              src={waliSantriAvatar} 
              alt="Wali Santri" 
              className="w-7 h-7 rounded-full object-cover border-2 border-black shrink-0" 
            />
            <span>Masuk User Biasa (Wali Santri)</span>
          </button>
        </div>
      </motion.div>
